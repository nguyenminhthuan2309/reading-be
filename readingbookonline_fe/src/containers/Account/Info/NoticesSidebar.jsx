const NoticesSidebar = () => {
  return (
    <aside className="w-[24%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col grow px-5 pt-11 pb-6 w-full text-black bg-orange-100 rounded-xl border-4 border-amber-600 border-solid max-md:mt-8">
        ...
        <p className="px-3.5 pt-8 mt-10 text-lg bg-white rounded-xl pb-[860px] max-md:pr-5 max-md:pb-28 max-md:mt-10">
